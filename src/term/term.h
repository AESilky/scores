...
/**
 * @brief Message handler for MSG_STDIO_CHAR_READY to read from STDIO
 *  into our terminal buffer.
 * @ingroup term
 *
 * @param msg MSG_STDIO_CHAR_READY message. Nothing in the data.
 */
extern void stdio_chars_read(cmt_msg_t* msg);
 ...
 * is returned.
 *
 * @return text_position_t
 */
extern text_position_t term_get_cursor_position(void);
